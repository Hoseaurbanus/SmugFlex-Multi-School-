...
function e(e2, n2) {
  ...
  for (var t2 = 0, a2 = Array(n2); t2 < n2; t2++) a2[t2] = e2[t2];
  return a2;
}
function n(e2, n2) {
...
function t(e2, n2) {
  for (var t2 = 0; t2 < n2.length; t2++) {
    var a2 = n2[t2];
    a2.enumerable = a2.enumerable || false, a2.configurable = true, "value" in a2 && (a2.writable = true), Object.defineProperty(e2, u(a2.key), a2);
  }
}
function a(e2, n2, a2) {
  return n2 && t(e2.prototype, n2), a2 && t(e2, a2), Object.defineProperty(e2, "prototype", { writable: false }), e2;
}
function i(e2, n2, t2) {
  return (n2 = u(n2)) in e2 ? Object.defineProperty(e2, n2, { value: t2, enumerable: true, configurable: true, writable: true }) : e2[n2] = t2, e2;
}
function o(e2, n2) {
...
function r(e2) {
  for (var n2 = 1; n2 < arguments.length; n2++) {
    ...
    n2 % 2 ? o(Object(t2), true).forEach(function(n3) {
      i(e2, n3, t2[n3]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e2, Object.getOwnPropertyDescriptors(t2)) : o(Object(t2)).forEach(function(n3) {
...
function c(e2, n2) {
  if (null == e2) return {};
  var t2, a2, i2 = (function(e3, n3) {
    if (null == e3) return {};
    var t3 = {};
    for (var a3 in e3) if ({}.hasOwnProperty.call(e3, a3)) {
      if (-1 !== n3.indexOf(a3)) continue;
      t3[a3] = e3[a3];
    }
    return t3;
  })(e2, n2);
  if (Object.getOwnPropertySymbols) {
    ...
    for (a2 = 0; a2 < o2.length; a2++) t2 = o2[a2], -1 === n2.indexOf(t2) && {}.propertyIsEnumerable.call(e2, t2) && (i2[t2] = e2[t2]);
  }
  return i2;
}
function s(e2, n2) {
  return (function(e3) {
    ...
    if (null != t2) {
      ...
      try {
        if (o2 = (t2 = t2.call(e3)).next, 0 === n3) {
          if (Object(t2) !== t2) return;
          s2 = false;
        } else for (; !(s2 = (a2 = o2.call(t2)).done) && (c2.push(a2.value), c2.length !== n3); s2 = true) ;
      } catch (e4) {
        l2 = true, i2 = e4;
      } finally {
        try {
  ...
  })(e2, n2) || d(e2, n2) || (function() {
    throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
  })();
}
function l(n2) {
  return (function(n3) {
    if (Array.isArray(n3)) return e(n3);
  })(n2) || (function(e2) {
...
function d(n2, t2) {
  if (n2) {
    if ("string" == typeof n2) return e(n2, t2);
    var a2 = {}.toString.call(n2).slice(8, -1);
    return "Object" === a2 && n2.constructor && (a2 = n2.constructor.name), "Map" === a2 || "Set" === a2 ? Array.from(n2) : "Arguments" === a2 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(a2) ? e(n2, t2) : void 0;
  }
}
...
function f(e2, n2) {
  var t2 = [];
  return Object.keys(e2).forEach(function(a2) {
    var i2 = n2 ? "".concat(n2, "[").concat(a2, "]") : a2, o2 = e2[i2];
...
var S = function() {
  ...
  return _() && e2.includes("apple_pay");
};
function E() {
  var e2 = 0;
  return Array.from(document.querySelectorAll("body *")).forEach(function(n2) {
    var t2 = window.getComputedStyle(n2), a2 = parseFloat(t2.zIndex);
    !Number.isNaN(a2) && a2 > e2 && (e2 = a2);
  }), e2;
}
function A(e2) {
...
function H(e2, n2, t2) {
  var a2 = n2.channels, i2 = void 0 === a2 ? [] : a2, o2 = n2.styles, r2 = void 0 === o2 ? {} : o2, c2 = { applePay: false };
  return new Promise(function(n3, a3) {
    if (e2) if (S(i2)) {
      if (T(e2)) return c2.applePay = true, void n3(c2);
      (function(e3, n4) {
        var t3 = n4.container, a4 = n4.integrity;
        return new Promise(function(n5, i3) {
          e3 || i3("No script url");
          var o3 = document.createElement("script");
          o3.src = e3, o3.crossOrigin = "anonymous", a4 && (o3.integrity = a4), o3.addEventListener("load", function() {
            n5(true);
          }), o3.addEventListener("error", function() {
            o3.remove(), i3(false);
          }), t3 ? t3.appendChild(o3) : document.head.appendChild(o3);
        });
      })("https://applepay.cdn-apple.com/jsapi/v1.1.0/apple-pay-sdk.js", { container: e2, integrity: "sha384-z/6BVHCcSypLSykOVpaT1PQWHOOgU45uOOlMkgi/bElX4yFqmChNMb7qiv80wFav" }).then(function() {
        ...
        !(function(e3, n4) {
          var t3, a4, i3, o3, r3, c3 = n4.styles, s2 = n4.theme, l2 = document.createElement("style"), u2 = (a4 = (t3 = c3).height, i3 = t3.width, o3 = t3.borderRadius, r3 = t3.padding, "\n  apple-pay-button {\n    --apple-pay-button-width: ".concat(i3, ";\n    --apple-pay-button-height: ").concat(a4, ";\n    --apple-pay-button-border-radius: ").concat(o3, ";\n    --apple-pay-button-padding: ").concat(r3, ";\n    --apple-pay-button-box-sizing: border-box;\n    width: ").concat(i3, ";\n  }\n"));
          l2.type = "text/css", l2.styleSheet ? l2.styleSheet.cssText = u2 : l2.appendChild(document.createTextNode(u2)), e3.appendChild(l2);
          var p2 = document.createElement("apple-pay-button");
          p2.setAttribute("buttonstyle", "light" === s2 ? "white" : "black"), p2.setAttribute("type", c3.type), p2.setAttribute("locale", c3.locale), e3.appendChild(p2);
        })(e2, { styles: x(r2.applePay), theme: r2.theme }), c2.applePay = true, n3(c2);
      }).catch(function() {
        !(function(e3, n4) {
          var t3, a4, i3, o3, r3, c3, s2, l2 = n4.styles, u2 = n4.theme, p2 = document.createElement("style"), d2 = (a4 = (t3 = l2).height, i3 = t3.width, o3 = t3.borderRadius, r3 = t3.padding, c3 = t3.type, s2 = t3.locale, "\n  @supports (-webkit-appearance: -apple-pay-button) { \n    .apple-pay-button {\n        display: inline-block;\n        -webkit-appearance: -apple-pay-button;\n        width: ".concat(i3, ";\n        height: ").concat(a4, ";\n        border-radius: ").concat(o3, ";\n        padding: ").concat(r3, ";\n        -apple-pay-button-type: ").concat(c3, ";\n        -webkit-locale: ").concat(s2, ";\n    }\n    .apple-pay-button-black {\n        -apple-pay-button-style: black;\n    }\n    .apple-pay-button-white {\n        -apple-pay-button-style: white;\n    }\n    .apple-pay-button-white-with-line {\n        -apple-pay-button-style: white-outline;\n    }\n  }\n\n  @supports not (-webkit-appearance: -apple-pay-button) {\n    .apple-pay-button {\n        display: inline-block;\n        background-size: 100% 60%;\n        background-repeat: no-repeat;\n        background-position: 50% 50%;\n        border-radius: 5px;\n        padding: 0px;\n        box-sizing: border-box;\n        min-width: 200px;\n        min-height: 32px;\n        max-height: 64px;\n    }\n    .apple-pay-button-black {\n        background-image: -webkit-named-image(apple-pay-logo-white);\n        background-color: black;\n    }\n    .apple-pay-button-white {\n        background-image: -webkit-named-image(apple-pay-logo-black);\n        background-color: white;\n    }\n    .apple-pay-button-white-with-line {\n        background-image: -webkit-named-image(apple-pay-logo-black);\n        background-color: white;\n        border: .5px solid black;\n    }\n  }\n"));
          p2.type = "text/css", p2.styleSheet ? p2.styleSheet.cssText = d2 : p2.appendChild(document.createTextNode(d2)), e3.appendChild(p2);
          ...
          C2.classList.add("logo"), h2.appendChild(C2), e3.appendChild(h2);
        })(e2, { styles: x(r2.applePay), theme: r2.theme }), c2.applePay = true, n3(c2);
      });
...
var z = "payment-request-button";
var O = "paystackpop-button";
var j = "pay-with-vault-button";
function N(e2) {
  var n2 = document.createElement("button");
  return n2.id = O, n2.className = "open-paystack-pop-button", n2.innerText = e2, n2;
}
function U(e2) {
  return e2.querySelector("#".concat(O));
}
function F() {
...
function D(e2, n2) {
  var t2 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, a2 = document.querySelector("#pre-checkout-modal-".concat(e2));
  if (a2) {
    if (U(a2) && Z(a2)) return a2;
    a2.remove();
  }
  var i2 = document.createElement("div");
  i2.classList.add("pre-checkout-modal"), i2.id = "pre-checkout-modal-".concat(e2), i2.style.zIndex = E() + 1;
  var o2 = document.createElement("div");
  o2.classList.add("pre-checkout-modal__content"), i2.appendChild(o2);
  var r2 = n2 || {}, c2 = r2.merchant_logo, s2 = r2.merchant_name, l2 = r2.email, u2 = r2.amount, p2 = r2.currency, d2 = r2.label, h2 = r2.channels, C2 = new Intl.NumberFormat("en", { style: "currency", currency: p2, currencyDisplay: "code", maximumFractionDigits: 2, minimumFractionDigits: 0 }).format(u2 / 100), m2 = document.createElement("div");
  m2.classList.add("payment-info"), m2.innerHTML = '<img class="merchant-logo" src="'.concat(c2, '" alt="').concat(s2, ' Logo">\n    <div class="customer-info">\n      <div class="customer-email">').concat(d2 || l2, '</div>\n      <div class="transaction-amount">Pay <span class="amount">').concat(C2, "</span></div>\n    </div>"), o2.appendChild(m2), o2.innerHTML += '\n  <button type="button" id="apple-pay-close-button">\n    <svg width="10" height="9" fill="none" xmlns="http://www.w3.org/2000/svg">\n      <path\n        d="M5.572 4.033L8.89.71a.4.4 0 0 0-.566-.566L5.003 3.459 1.681.145a.4.4 0 0 0-.566.566L4.44 4.033\n      1.115 7.354a.398.398 0 0 0 0 .566.4.4 0 0 0 .566 0l3.322-3.33 3.322 3.33a.4.4 0 0 0 .566-.566L5.57 4.033z"\n        fill="white"\n      />\n    </svg>\n  </button>\n';
  var y2 = document.createElement("div");
  y2.classList.add("modal-wrapper"), t2.canPayWithVault ? B(y2, { canPayWithApplePay: t2.canPayWithApplePay, hasOtherPaymentMethods: R(h2) }) : (function(e3, n3) {
    var t3 = n3.hasOtherPaymentMethods, a3 = document.createElement("div");
...
function K(e2) {
  ...
  return void 0 !== o2.card && ["false", false].indexOf(o2.card) > -1 && (o2.channels = ["bank"], delete o2.card), void 0 !== o2.bank && ["false", false].indexOf(o2.bank) > -1 && (o2.channels = ["card"], delete o2.bank), [{ to: "firstname", from: "firstName" }, { to: "lastname", from: "lastName" }, { to: "customer_code", from: "customerCode" }, { to: "payment_request", from: "paymentRequest" }, { to: "subaccount", from: "subaccountCode" }, { to: "transaction_charge", from: "transactionCharge" }, { to: "plan", from: "planCode" }, { to: "quantity", from: "subscriptionCount" }, { to: "interval", from: "planInterval" }, { to: "invoice_limit", from: "subscriptionLimit" }, { to: "start_date", from: "subscriptionStartDate" }, { to: "ref", from: "reference" }].forEach(function(e3) {
    o2[e3.from] && (o2[e3.to] = o2[e3.from], delete o2[e3.from]);
  }), Object.values(e2).forEach(function(n3, t3) {
    if ("function" == typeof n3) {
      var a3 = Object.keys(e2)[t3];
      delete o2[a3];
    }
  }), o2;
}
var Q = ["iPad Simulator", "iPhone Simulator", "iPod Simulator", "iPad", "iPhone", "iPod"];
var G = window && window.navigator && (window.navigator.platform || window.navigator.userAgentData && window.navigator.userAgentData.platform);
var Y = function() {
  var e2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n2 = e2.platform, t2 = e2.userAgent, a2 = void 0 === t2 ? window && window.navigator && window.navigator.userAgent : t2, i2 = n2 || G;
  return Q.includes(i2) || a2.includes("Mac") && "ontouchend" in document;
};
var X = function(e2, n2, t2) {
  var a2 = "".concat(y.paystackApiUrl, "transaction/update_log/").concat(e2), i2 = { Authorization: "Bearer ".concat(n2) };
  return fetch(a2, { method: "POST", body: JSON.stringify({ payload: JSON.stringify(t2) }), headers: i2 });
};
var $ = function(e2, n2) {
  var t2 = "".concat(y.paystackApiUrl, "transaction/set_ip/").concat(e2), a2 = { Authorization: "Bearer ".concat(n2) };
  return fetch(t2, { method: "POST", headers: a2 });
};
var ee = { initializeLog: function(e2) {
  var n2 = e2 || {}, t2 = n2.attempts, a2 = n2.authentication, i2 = n2.errors, o2 = n2.history;
  this.log = { start_time: Math.round(Date.now() / 1e3), time_spent: 0, attempts: t2 || 0, authentication: a2, errors: i2 || 0, success: false, mobile: Y(), input: [], history: o2 || [] };
...
var ne = ["language", "connect_account"];
var te = { requestInline: function() {
  var e2 = this, n2 = this.urlParameters, t2 = n2.language, a2 = n2.connect_account, i2 = c(n2, ne), o2 = r({ "Content-Type": "application/json" }, t2 && { "Accept-Language": t2 });
  return (this.accessCode ? fetch(new URL("transaction/verify_access_code/".concat(this.accessCode), y.paystackApiUrl).toString(), { headers: o2 }) : fetch(new URL("/checkout/request_inline", y.paystackApiUrl).toString(), { method: "POST", body: JSON.stringify(i2), headers: r(r({}, o2), a2 && { "x-connect-account": a2 }) })).then(function(e3) {
    return e3.json();
  }).then(function(n3) {
    if (false === n3.status) throw new Error(n3.message);
    return e2.response = n3.data, e2.id = n3.data.id, e2.status = n3.data.transaction_status, e2.accessCode = n3.data.access_code, e2.log = null, Object.assign(e2, ee), e2.initializeLog(n3.data.log), e2.saveIpAddress(), n3.data;
  });
} };
var ae = (function() {
  return a(function e2(t2) {
    n(this, e2), (function(e3) {
      function n2(e4, n3) {
        this.message = e4, this.issues = n3 || [];
      }
      if (!e3 || "object" !== p(e3)) throw new n2("Transaction parameters should be a non-empty object");
      var t3 = e3;
      if ("accessCode" in t3) return { accessCode: t3.accessCode };
      Object.keys(t3).forEach(function(e4) {
        void 0 !== W.find(function(n3) {
          return n3.value === e4;
        }) || delete t3[e4];
      });
      var a3 = Object.keys(t3), i3 = [];
      if (W.filter(function(e4) {
        return e4.required;
      }).forEach(function(e4) {
        var n3 = !t3[e4.value], a4 = e4.or ? e4.or.some(function(e5) {
          return t3[e5];
        }) : null;
        n3 && !a4 && i3.push({ message: "Required parameter missing: ".concat(e4.value) });
      }), a3.forEach(function(e4) {
        var n3 = t3[e4], a4 = W.find(function(n4) {
          return n4.value === e4;
        }), o3 = p(n3);
        "object" === o3 && Array.isArray(n3) && (o3 = "array"), a4.types.indexOf(o3) <= -1 && i3.push({ message: "Invalid parameter type: ".concat(e4), validTypes: a4.types });
      }), a3.forEach(function(e4) {
        var n3 = W.find(function(n4) {
          return n4.value === e4;
        });
        n3.override && delete t3[n3.override];
      }), i3.length) throw new n2("Invalid transaction parameters", i3);
    })(t2), this.parameters = t2, this.urlParameters = K(t2), this.id = null, this.status = null, this.accessCode = t2.accessCode || null, this.authorizationUrl = null, this.errors = [], this.response = null, this.isActive = true;
    ...
    this.callbacks = { onError: a2, onLoad: i2, onSuccess: o2, onCancel: r2, onBankTransferConfirmationPending: l2 }, this.deprecatedCallbacks = { callback: c2, onClose: s2 }, Object.assign(this, te);
  }, [{ key: "onSetupError", value: function(e2) {
    this.logError(e2), this.callbacks.onError && this.callbacks.onError(e2);
  } }, { key: "onLoad", value: function(e2) {
    var n2 = e2.id, t2 = e2.customer, a2 = e2.accessCode;
    Object.assign(this, { id: n2, customer: t2, accessCode: a2 }), this.authorizationUrl = "".concat(y.checkoutUrl).concat(a2), this.callbacks.onLoad && this.callbacks.onLoad({ id: n2, customer: t2, accessCode: a2 });
  } }, { key: "onSuccess", value: function(e2) {
    this.isActive = false, this.response = e2, this.status = e2.status, this.callbacks.onSuccess && this.callbacks.onSuccess(e2), this.deprecatedCallbacks.callback && this.deprecatedCallbacks.callback(e2);
  } }, { key: "setStatus", value: function(e2) {
    this.status = e2;
  ...
  } }, { key: "logError", value: function(e2) {
    this.errors.push(e2);
  } }]);
})();
var ie = console ? console.warn || console.log : function() {
};
function oe(e2, n2, t2) {
  ie('"'.concat(e2, '" has been deprecated, please use "').concat(n2, '". ').concat(t2 || ""));
}
var re;
var ce = ["preload", "inlineTransaction", "transactionData"];
var se = ["container", "styles", "onElementsMount"];
function le(e2, n2) {
  if (!e2.length) return null;
  var t2 = e2.filter(function(e3) {
    var t3, a2, i2, o2, r2 = !e3.status || "abandoned" === e3.status, c2 = (t3 = e3.parameters, a2 = n2, i2 = Object.keys(t3).sort().join("") === Object.keys(a2).sort().join(""), o2 = Object.values(t3).sort().join("") === Object.values(a2).sort().join(""), i2 && o2);
    return r2 && c2;
  });
...
var pe = "trackCheckoutClosed";
var de = "trackPaymentError";
var he = "trackPaymentAttempt";
var Ce = "trackPaymentCompletion";
function me(e2) {
  throw ie(e2), new Error(e2);
}
var ye;
var fe;
var ve = (function() {
  function e2(t2) {
    var a2, i2;
    n(this, e2), this.id = (function() {
      for (var e3 = "", n2 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", t3 = 0; t3 < 5; t3 += 1) e3 += n2.charAt(Math.floor(62 * Math.random()));
      return e3;
    })(), this.transactions = [], this.isOpen = false, this.isLoaded = false, this.isDeprecatedApi = t2 && t2.isDeprecatedApi, t2 && t2.isEmbed ? this.isEmbed = true : t2 && t2.isPaymentRequest && (t2.container && q(t2.container) || me("A container is required to mount the payment request button"), this.paymentRequestContainer = q(t2.container), this.paymentRequestTransaction = null), this.preCheckoutModal = null, this.backgroundIframe = (function(e3) {
      var n2 = A("inline-background-".concat(e3));
      n2.style.cssText = "\n  z-index: 999999999999999;\n  background: transparent;\n  background: rgba(0, 0, 0, 0.75);    \n  border: 0px none transparent;\n  overflow-x: hidden;\n  overflow-y: hidden;\n  margin: 0;\n  padding: 0;\n  -webkit-tap-highlight-color: transparent;\n  -webkit-touch-callout: none;\n  position: fixed;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  transition: opacity 0.3s;\n  -webkit-transition: opacity 0.3s;\n  visibility: hidden;\n  display: none;\n", n2.style.colorScheme = "light", document.body.appendChild(n2);
      var t3 = n2.contentWindow.document;
    ...
    })(this.id), this.checkoutIframe = (a2 = this.id, (i2 = A("inline-checkout-".concat(a2))).src = "".concat(y.checkoutUrl, "popup"), i2.style.cssText = "\n  z-index: 999999999999999;\n  background: transparent;\n  border: 0px none transparent;\n  overflow-x: hidden;\n  overflow-y: hidden;\n  margin: 0;\n  padding: 0;\n  -webkit-tap-highlight-color: transparent;\n  -webkit-touch-callout: none;\n  position: fixed;\n  left: 0;\n  top: 0;\n  width: 100%;\n  visibility: hidden;\n  display: none;\n  height: 100%;\n", i2.style.colorScheme = "light", i2.setAttribute("allowpaymentrequest", "true"), i2.setAttribute("allow", "payment; clipboard-read; clipboard-write"), document.body.appendChild(i2), i2), this.registerListeners();
  }
  return a(e2, [{ key: "registerListeners", value: function() {
    var e3 = this;
    window.addEventListener("message", function(n2) {
      var t2 = "".concat(n2.origin, "/") === y.checkoutUrl, a2 = e3.checkoutIframe && e3.checkoutIframe.contentWindow === n2.source, i2 = e3.isEmbed;
      t2 || a2 ? e3.respondToEvent(n2) : i2 && e3.respondToEmbedEvents(n2);
    });
    ...
    var n2 = le(this.transactions, e3) || new ae(e3);
    return new Promise(function(e4, t2) {
      n2.requestInline().then(function(t3) {
        var a2 = (function() {
          var e5 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n3 = e5.platform, t4 = e5.userAgent, a3 = void 0 === t4 ? window && window.navigator && window.navigator.userAgent : t4, i3 = n3 || G, o2 = a3 && !!a3.match(/Version\/[\d.]+.*Safari/), r2 = i3 && /(Mac)/i.test(i3);
          return Y() || r2 && o2;
        })() && S(t3.channels), i2 = (function() {
          var e5, n3, t4 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          return !(null === (e5 = t4.link_config) || void 0 === e5 || !e5.enabled || null === (n3 = t4.link_config) || void 0 === n3 || !n3.has_payment_instruments);
        })(t3);
        i2 || a2 ? (re.preloadTransaction({ inlineTransaction: n2, transactionData: t3 }), re.preCheckoutModal = D(re.id, t3, { canPayWithVault: i2, canPayWithApplePay: a2 }), a2 ? (re.paymentRequestContainer = Z(re.preCheckoutModal), H(re.paymentRequestContainer, { channels: t3.channels, styles: { applePay: { width: "100%", type: "pay", height: "42px", padding: "15px", borderRadius: "5px" } } }, t3.merchant_id).then(function() {
          re.registerPaymentRequestEventListeners();
        }).catch(function() {
          i2 ? Z(re.preCheckoutModal).remove() : (re.closePreCheckoutModal(), re.animateCheckoutIn());
        }).finally(function() {
          e4(n2);
        })) : e4(n2)) : (re.newTransaction({ inlineTransaction: n2, transactionData: t3 }), e4(n2));
      }).catch(function(e5) {
    ...
    var e3;
    this.registerPreCheckoutModalEventListeners(), e3 = this.preCheckoutModal, new Promise(function(n2, t2) {
      try {
        var a2 = e3.querySelector(".pre-checkout-modal__content");
        e3.classList.add("show"), setTimeout(function() {
          a2.classList.add("show"), n2(true);
        }, 50);
      } catch (e4) {
        t2(e4);
      }
    ...
    document.addEventListener("touchstart", function(n3) {
      ...
      n3.target && n3.target.isSameNode(re.preCheckoutModal) && t2 && (clearTimeout(e3), re.closePreCheckoutModal(), a2 && a2.cancel()), t2 = false;
    }, true);
    var i2 = U(this.preCheckoutModal);
    i2 && (i2.onclick = function() {
      n2.closePreCheckoutModal(), n2.animateCheckoutIn();
    });
    var o2 = this.preCheckoutModal.querySelector("#".concat(j));
    o2 && (o2.onclick = function() {
      n2.closePreCheckoutModal(), n2.animateCheckoutIn(), n2.checkoutIframe.contentWindow.postMessage({ type: "inline:pay-with-vault" }, "*");
    });
    var r2 = (function(e4) {
      return e4.querySelector("#apple-pay-close-button");
    })(this.preCheckoutModal);
    r2.onclick = function() {
      n2.sendAnalyticsEventToCheckout(pe), n2.closePreCheckoutModalAndCancelTransaction();
    };
  } }, { key: "closePreCheckoutModal", value: function(e3) {
    var n2;
    this.preCheckoutModal && ("failed" === e3 ? (n2 = this.preCheckoutModal) && (n2.querySelector("#apple-pay-mark--light").innerHTML = '<svg width="50" height="30" viewBox="0 0 21 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="error-icon">\n    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\n        <g id="error" fill-rule="nonzero">\n            <path d="M9.14672,0.47855 L0.14829,15.47855 C-0.0403320234,15.7872042 -0.0475647902,16.1736607 0.129375884,16.4891566 C0.306316558,16.8046526 0.639843999,16.9999993 1.00157,17 L19.43546,17 C19.797186,16.9999993 20.1307134,16.8046526 20.3076541,16.4891566 C20.4845948,16.1736607 20.477362,15.7872042 20.28874,15.47855 L10.85328,0.47855 C10.671624,0.181297031 10.3483651,3.00996351e-06 10,3.00996351e-06 C9.6516349,3.00996351e-06 9.32837603,0.181297031 9.14672,0.47855 Z" id="Shape" fill="#FFAA22"></path>\n            <rect id="Rectangle-path" fill="#FFFFFF" x="9" y="6" width="2" height="5"></rect>\n            <rect id="Rectangle-path" fill="#FFFFFF" x="9" y="12" width="2" height="2"></rect>\n        </g>\n    </g>\n</svg>', n2.querySelector("#apple-pay-description").textContent = "An error occurred while paying with Apple Pay. Please try again or use another payment method.") : (!(function(e4) {
      e4 && (e4.querySelector(".pre-checkout-modal__content").classList.remove("show"), e4.classList.remove("show"));
    ...
    var n2 = e3.preload, t2 = e3.inlineTransaction, a2 = e3.transactionData, i2 = c(e3, ce), o2 = this.paymentRequestContainer && T(this.paymentRequestContainer);
    if (this.activeTransaction() && !o2 && this.activeTransaction().cancel(), t2 && a2) return this.transactions.push(t2), this.isDeprecatedApi || this.open({ accessCode: a2.access_code, language: t2.urlParameters.language }, n2), t2;
    var r2 = le(this.transactions, t2 ? t2.parameters : i2);
    if (r2) return r2.isActive = true, this.isDeprecatedApi || this.open({ accessCode: r2.accessCode, language: r2.urlParameters.language }, n2), r2;
    var s2 = t2 || new ae(i2), l2 = s2.accessCode ? { accessCode: s2.accessCode, language: s2.urlParameters.language } : s2.urlParameters;
    return this.transactions.push(s2), this.isDeprecatedApi || this.open(l2, n2), s2;
  } }, { key: "preloadTransaction", value: function(e3) {
    var n2 = this;
    this.newTransaction(r(r({}, e3), {}, { preload: true }));
    return function() {
      return n2.animateCheckoutIn();
    };
  } }, { key: "paymentRequest", value: function(e3) {
    var n2 = e3.container, t2 = e3.styles, a2 = e3.onElementsMount, i2 = c(e3, se);
    return re = this, new Promise(function(o2, r2) {
      var c2 = document.querySelector("#".concat(e3.loadPaystackCheckoutButton));
      if (_()) {
        re.activeTransaction() && re.activeTransaction().cancel(), n2 && q(n2) || me("A container is required to mount the payment request button"), re.paymentRequestContainer = q(n2);
        var s2 = le(re.transactions, i2), l2 = s2 || new ae(i2);
        l2.requestInline().then(function(e4) {
          H(re.paymentRequestContainer, { channels: e4.channels, styles: t2 }, e4.merchant_id).then(function(e5) {
            a2 && a2(e5);
          }).catch(function() {
            a2 && a2(null);
          }).finally(function() {
            if (s2 ? l2.isActive = true : re.transactions.push(l2), re.registerPaymentRequestEventListeners(), c2) {
              var n3 = re.preloadTransaction({ inlineTransaction: l2, transactionData: e4 });
              c2.onclick = n3;
            }
            o2(l2);
          });
        }).catch(function(e4) {
          l2.onSetupError({ status: false, message: e4.message }), r2(e4);
        });
      } else {
        if (e3 && e3.loadPaystackCheckoutButton) if (c2) {
          var u2 = re.preloadTransaction(i2);
          c2.onclick = u2;
    ...
    e3 && S(e3.response.channels) ? this.registerApplePayEventListener() : I(this.paymentRequestContainer);
  } }, { key: "startApplePay", value: function() {
    var e3, n2, t2, a2, i2, o2 = this, c2 = "apple pay", s2 = this.activeTransaction();
    if (s2) {
      ...
      try {
        s2.logAttempt(c2), this.sendAnalyticsEventToCheckout(he, l2);
        var p2 = (e3 = { currency: s2.response.currency, amount: s2.response.amount, merchantName: s2.response.merchant_name, interval: s2.response.plan_details && s2.response.plan_details.interval }, n2 = e3.currency, t2 = e3.amount, a2 = e3.merchantName, i2 = e3.interval, r({ countryCode: "NG", currencyCode: n2, merchantCapabilities: ["supports3DS", "supportsCredit", "supportsDebit"], supportedNetworks: ["visa", "masterCard"], requiredBillingContactFields: ["postalAddress", "name", "phone", "email"], total: { label: "".concat(a2, " - Paystack"), type: "final", amount: String(M(t2)) } }, "string" == typeof i2 && "" !== i2.trim() && { lineItems: [{ label: L(i2), amount: String(M(t2)) }] })), d2 = new window.ApplePaySession(y.applePayVersion, p2);
        d2.onvalidatemerchant = function(e4) {
          var n3 = (function(e5) {
            var n4 = e5.transactionId, t3 = e5.validationURL, a3 = e5.merchantName, i3 = e5.domainName, o3 = void 0 === i3 ? window && window.location && window.location.hostname : i3, c3 = "".concat(y.paymentBaseUrl).concat(y.applePayValidateSessionPath), s3 = V({ transaction: n4, sessionUrl: t3, displayName: a3, domainName: o3 });
            return fetch(c3, r(r({}, P), {}, { body: s3 })).then(function(e6) {
              return e6.json();
            });
          ...
          re.preCheckoutModal || s2.onCancel();
        }, d2.onpaymentauthorized = function(e4) {
          var n3 = e4.payment, t3 = (function(e5) {
            var n4 = e5.transactionId, t4 = e5.payment, a3 = "".concat(y.paymentBaseUrl).concat(y.applePayChargePath), i3 = V({ transaction: n4, paymentObject: JSON.stringify(t4) });
            return fetch(a3, r(r({}, P), {}, { body: i3 })).then(function(e6) {
              return e6.json();
            });
          })({ transactionId: s2.id, payment: n3 });
          t3.then(function(e5) {
            s2.logAPIResponse(e5, c2), "success" === e5.status ? (d2.completePayment(d2.STATUS_SUCCESS), s2.onSuccess(e5), o2.sendAnalyticsEventToCheckout(Ce, u2)) : (d2.completePayment(d2.STATUS_FAILURE), s2.onSetupError(e5), o2.sendAnalyticsEventToCheckout(de, { channel: "apple_pay", message: e5 && e5.message || "Transaction attempt failed" })), re.closePreCheckoutModal(e5.status);
          }).catch(function(e5) {
            d2.completePayment(d2.STATUS_FAILURE), s2.onSetupError(e5), o2.sendAnalyticsEventToCheckout(de, { channel: "apple_pay", message: e5 && e5.message || "Error occurred" }), re.closePreCheckoutModal("failed");
          });
        }, d2.begin();
      } catch (e4) {
        s2.onSetupError(e4);
    ...
    var n2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, t2 = n2.onSuccess, a2 = n2.onCancel, i2 = n2.onLoad, o2 = n2.onError;
    return this.newTransaction({ accessCode: e3, onSuccess: t2, onCancel: a2, onLoad: i2, onError: o2 });
    ...
    if (e3) {
      ...
      try {
        var i2 = e3.data || e3.message, o2 = i2.event, r2 = i2.data;
        if (o2) switch (o2) {
          case "loaded:checkout":
            if (this.isLoaded = true, a2) {
              var c2 = this.checkoutIframe, s2 = a2.urlParameters, l2 = a2.response;
              ue({ checkoutIframe: c2, urlParameters: l2 ? { accessCode: l2.access_code, language: null == s2 ? void 0 : s2.language } : s2 });
            }
            break;
          case "loaded:transaction":
            n2 = this.backgroundIframe, (t2 = n2.contentWindow.document) && (t2.getElementById("app-loader").style.display = "none"), this.preCheckoutModal && this.openPreCheckoutModal(), a2.onLoad(r2);
            break;
          case "error":
          ...
          case "close":
            this.close();
            var u2 = r2 && r2.status;
            u2 && a2.setStatus(u2), !(this.paymentRequestContainer && T(this.paymentRequestContainer) && !this.preCheckoutModal) && (a2.isActive = false), a2.onCancel();
            break;
    ...
    var n2, t2, a2 = this.activeTransaction(), i2 = e3.data || e3.message;
    if (i2 && ("string" == typeof i2 || i2 instanceof String)) {
      var o2 = { action: t2 = (n2 = i2) && "string" == typeof n2 ? n2.split(" ")[0] : null, data: t2 ? n2.split(" ").slice(2).join(" ") : null };
    ...
    if (!this.isOpen) {
      ...
      (e3 = { checkoutIframe: t2, backgroundIframe: a2 }, new Promise(function(n3, t3) {
        ...
        var a3 = e3.checkoutIframe, i2 = e3.backgroundIframe;
        a3 && i2 || t3("No dom element provided"), a3.style.display = "", a3.style.visibility = "visible", i2.style.display = "", i2.style.visibility = "visible", n3();
      })).then(function() {
        n2.checkoutIframe.contentWindow.postMessage("render", "*");
      }), this.isOpen = true;
    }
  } }, { key: "open", value: function(e3, n2) {
    e3 && (ue({ checkoutIframe: this.checkoutIframe, urlParameters: e3 }), n2 || this.animateCheckoutIn());
    ...
    re || (re = new e2({ isDeprecatedApi: true, isEmbed: t2 })), oe("PaystackPop.setup()", "new PaystackPop()", "Please consult our documentation at https://developers.paystack.co/docs/paystack-inline");
    var a2 = re.newTransaction(n2, "deprecated"), i2 = a2.urlParameters;
    if (t2) {
      var o2 = "".concat(y.siteUrl, "/assets/payment/production/inline.html?").concat(f(i2)), r2 = (function(e3, n3) {
        var t3 = A("embed-checkout-".concat(e3));
        return t3.style.cssText = "\n  background: transparent;\n  background: rgba(0,0,0,0);\n  border: 0px none transparent;\n  overflow-x: hidden;\n  overflow-y: hidden;\n  nmargin: 0;\n  padding: 0;\n  -webkit-tap-highlight-color: transparent;\n  -webkit-touch-callout: none;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  visibility: hidden;\n  display: none;\n", t3.src = n3, t3.id = e3, t3.name = e3, t3.setAttribute("allowpaymentrequest", "true"), t3.setAttribute("allow", "payment; clipboard-read; clipboard-write"), t3;
      })(re.id, o2);
      !(function(e3, n3) {
      ...
      })(n2.container, r2), r2.onload = function() {
        var e3;
        r2.contentWindow.postMessage("PaystackOpen ".concat(re.id), "*"), e3 = r2, new Promise(function(n3, t3) {
          e3 || t3("No dom element provided"), e3.style.display = "", e3.style.visibility = "visible", n3();
        });
      };
    } else a2.openIframe = function() {
      oe("openIframe", "open", "Please consult our documentation at https://developers.paystack.co/docs/paystack-inline"), re.open(i2);
    };
    return a2;
  } }]);
})();
if (ye = b().length > 0, fe = g() && "FORM" === g().parentElement.tagName, ye && fe) {
  be = (function() {
    ...
    return b().forEach(function(t2) {
      var a2 = n2.getAttribute(t2), i2 = t2.split("data-")[1].replace(/-([a-z])/g, function(e3) {
        return e3[1].toUpperCase();
      });
      e2[i2] = a2;
    }), (function(e3) {
      if (e3.buttonId && !document.getElementById(e3.buttonId)) throw new Error("Please make sure the buttonId is an element available in the DOM");
      var n3 = r({}, e3);
      n3.buttonText = e3.buttonText || "Pay", n3.buttonVariant = "normal", n3.buttonWordmarkVariant = "normal";
      var t2 = ["normal", "light"];
      return e3.buttonVariant && t2.indexOf(e3.buttonVariant) > -1 && (n3.buttonVariant = e3.buttonVariant), e3.buttonWordmarkVariant && t2.indexOf(e3.buttonWordmarkVariant) > -1 && (n3.buttonWordmarkVariant = e3.buttonWordmarkVariant), n3;
    })(e2);
  })(), ke = g().parentElement;
  re || (re = new ve()), (function(e2) {
    var n2;
    if (e2.id) (n2 = document.getElementById(e2.id)).setAttribute("data-inline-id", e2.id);
    else {
    ...
    return n2;
  })({ inlineId: re.id, amount: be.amount / 100, currency: be.currency, id: be.buttonId, text: be.buttonText, variant: be.buttonVariant, wordmarkVariant: be.buttonWordmarkVariant, parent: g() }).addEventListener("click", function(e2) {
    e2.preventDefault(), ge ? re.resumeTransaction(ge.accessCode) : ge = re.newTransaction(r(r({}, be), {}, { onSuccess: function(e3) {
      var n2, t2, a2, i2, o2, r2;
      n2 = { type: "hidden", name: "reference", value: e3.reference, parent: ke }, t2 = n2.type, a2 = n2.value, i2 = n2.name, o2 = n2.parent, (r2 = document.createElement("input")).type = t2, r2.value = a2, r2.name = i2, o2.appendChild(r2), ke.submit();
    } }));
  });
}
var ge;
