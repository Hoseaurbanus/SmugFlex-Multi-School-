import{r as s}from"./react-vendor-CYUoSQuD.js";import{s as f}from"./vendor-react-style-singleton-DFBvSsD8.js";var d="right-scroll-bar-position",g="width-before-scroll-bar",p="with-scroll-bars-hidden",h="--removed-body-scroll-bar-size",m={left:0,top:0,right:0,gap:0},l=function(n){return parseInt(n||"",10)||0},b=function(n){var r=window.getComputedStyle(document.body),o=r[n==="padding"?"paddingLeft":"marginLeft"],t=r[n==="padding"?"paddingTop":"marginTop"],e=r[n==="padding"?"paddingRight":"marginRight"];return[l(o),l(t),l(e)]},y=function(n){if(n===void 0&&(n="margin"),typeof window=="undefined")return m;var r=b(n),o=document.documentElement.clientWidth,t=window.innerWidth;return{left:r[0],top:r[1],right:r[2],gap:Math.max(0,t-o+r[2]-r[0])}},w=f(),c="data-scroll-locked",x=function(n,r,o,t){var e=n.left,i=n.top,v=n.right,a=n.gap;return o===void 0&&(o="margin"),`
  .`.concat(p,` {
