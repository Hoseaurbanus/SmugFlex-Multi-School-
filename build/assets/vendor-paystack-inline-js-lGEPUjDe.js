function F(e,n){(n==null||n>e.length)&&(n=e.length);for(var t=0,a=Array(n);t<n;t++)a[t]=e[t];return a}function l1(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function J(e,n){for(var t=0;t<n.length;t++){var a=n[t];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,h1(a.key),a)}}function u1(e,n,t){return n&&J(e.prototype,n),t&&J(e,t),Object.defineProperty(e,"prototype",{writable:!1}),e}function p1(e,n,t){return(n=h1(n))in e?Object.defineProperty(e,n,{value:t,enumerable:!0,configurable:!0,writable:!0}):e[n]=t,e}function K(e,n){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(e);n&&(a=a.filter(function(o){return Object.getOwnPropertyDescriptor(e,o).enumerable})),t.push.apply(t,a)}return t}function g(e){for(var n=1;n<arguments.length;n++){var t=arguments[n]!=null?arguments[n]:{};n%2?K(Object(t),!0).forEach(function(a){p1(e,a,t[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):K(Object(t)).forEach(function(a){Object.defineProperty(e,a,Object.getOwnPropertyDescriptor(t,a))})}return e}function Z(e,n){if(e==null)return{};var t,a,o=(function(r,s){if(r==null)return{};var c={};for(var l in r)if({}.hasOwnProperty.call(r,l)){if(s.indexOf(l)!==-1)continue;c[l]=r[l]}return c})(e,n);if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(e);for(a=0;a<i.length;a++)t=i[a],n.indexOf(t)===-1&&{}.propertyIsEnumerable.call(e,t)&&(o[t]=e[t])}return o}function _1(e,n){return(function(t){if(Array.isArray(t))return t})(e)||(function(t,a){var o=t==null?null:typeof Symbol!="undefined"&&t[Symbol.iterator]||t["@@iterator"];if(o!=null){var i,r,s,c,l=[],m=!0,f=!1;try{if(s=(o=o.call(t)).next,a!==0)for(;!(m=(i=s.call(o)).done)&&(l.push(i.value),l.length!==a);m=!0);}catch(p){f=!0,r=p}finally{try{if(!m&&o.return!=null&&(c=o.return(),Object(c)!==c))return}finally{if(f)throw r}}return l}})(e,n)||C1(e,n)||(function(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)})()}function d1(e){return(function(n){if(Array.isArray(n))return F(n)})(e)||(function(n){if(typeof Symbol!="undefined"&&n[Symbol.iterator]!=null||n["@@iterator"]!=null)return Array.from(n)})(e)||C1(e)||(function(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)})()}function h1(e){var n=(function(t,a){if(typeof t!="object"||!t)return t;var o=t[Symbol.toPrimitive];if(o!==void 0){var i=o.call(t,a);if(typeof i!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(t)})(e,"string");return typeof n=="symbol"?n:n+""}function _(e){return _=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(n){return typeof n}:function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},_(e)}function C1(e,n){if(e){if(typeof e=="string")return F(e,n);var t={}.toString.call(e).slice(8,-1);return t==="Object"&&e.constructor&&(t=e.constructor.name),t==="Map"||t==="Set"?Array.from(e):t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)?F(e,n):void 0}}var D={cookieTestUrl:"https://legacy-staging.paystack.co/test-iframe/start.html",publishableKey:"uFmz/uE/SDT6GupOrSEXIZXGByjQ0zFkPyc9LqKHFqnTI0WPN3JS5kQPo/j9or0TOXlqMQj2lzHn/UGsQT4XeQ==",publicKey:`-----BEGIN PUBLIC KEY-----\r
...
-----END PUBLIC KEY-----`,applePayVersion:6,applePayValidateSessionPath:"applepay/validate-session/",applePayChargePath:"applepay/charge"};g(g({},D),{},{checkoutUrl:"http://localhost:8081/",paymentBaseUrl:"https://legacy-staging.paystack.co/",paystackApiUrl:"https://studio-api.paystack.co/",siteUrl:"https://paystack.com",pusherKey:"1c7b262ee18455815893",pusherUrl:"http://localhost:8081/static/vendor/pusher.min.js"});var S1=g(g({},D),{},{checkoutUrl:"https://checkout-studio.paystack.com/",paymentBaseUrl:"https://legacy-staging.paystack.co/",paystackApiUrl:"https://studio-api.paystack.co/",siteUrl:"https://beta.paystack.com",pusherKey:"1c7b262ee18455815893",pusherUrl:"https://checkout-studio.paystack.com/static/vendor/pusher.min.js"}),M={production:g(g({},D),{},{checkoutUrl:"https://checkout.paystack.com/",paymentBaseUrl:"https://standard.paystack.co/",paystackApiUrl:"https://api.paystack.co/",siteUrl:"https://paystack.com",pusherKey:"8e4b9b7ca3418bd5cdc8",pusherUrl:"https://checkout.paystack.com/static/vendor/pusher.min.js"})}.production||S1;function m1(e,n){var t=[];return Object.keys(e).forEach(function(a){var o=n?"".concat(n,"[").concat(a,"]"):a,i=e[o];t.push(i!==null&&(typeof v=="undefined"?"undefined":_(v))==="object"?m1(i,o):"".concat(encodeURIComponent(a),"=").concat(encodeURIComponent(i)))}),t.join("&")}function A(){return document.currentScript||(e=document.getElementsByTagName("script"))[e.length-1];var e}function Q(){var e=[],n=A();if(n){var t=Array.prototype.slice.call(n.attributes);e=Object.keys(t).filter(function(a){var o=t[a].nodeName;return o&&o.indexOf("data")>-1}).map(function(a){return t[a].nodeName})}return e}var f1=`
...
`,I={height:"50px",width:"auto",borderRadius:"3px",padding:"10px",locale:"en",type:"pay"},G=function(e){return e&&_(e)==="object"?Object.keys(I).reduce(function(n,t){return g(g({},n),{},p1({},t,e[t]||I[t]))},{}):I},Y=function(){return Number(parseFloat((arguments.length>0&&arguments[0]!==void 0?arguments[0]:0)/100).toFixed(2))},X={headers:{accept:"application/json, text/plain, */*","accept-language":"en-GB,en-US;q=0.9,en;q=0.8","content-type":"application/x-www-form-urlencoded","sec-ch-ua-mobile":"?0","sec-fetch-dest":"empty","sec-fetch-mode":"cors","sec-fetch-site":"cross-site"},referrerPolicy:"no-referrer-when-downgrade",method:"POST",mode:"cors",credentials:"omit"};function $(e){return Object.keys(e).reduce(function(n,t){var a=encodeURIComponent(t),o=encodeURIComponent(e[t]),i="".concat(a,"=").concat(o);return[].concat(d1(n),[i])},[]).join("&")}var E1=function(e){return{biannually:"BIANNUAL PLAN",annually:"ANNUAL PLAN"}[e]||"".concat(e.toUpperCase()," PLAN")},y1=function(){try{return window.location&&window.location.protocol==="https:"&&window.ApplePaySession&&window.ApplePaySession.supportsVersion(M.applePayVersion)}catch(e){return!1}},B=function(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:[];return y1()&&e.includes("apple_pay")};function n1(){var e=0;return Array.from(document.querySelectorAll("body *")).forEach(function(n){var t=window.getComputedStyle(n),a=parseFloat(t.zIndex);!Number.isNaN(a)&&a>e&&(e=a)}),e}function z(e){var n=document.createElement("iframe");return n.setAttribute("frameBorder","0"),n.setAttribute("allowtransparency","true"),n.id=e,n.style.display="none",n}function H(e){return e.querySelector("apple-pay-button")||e.querySelector("#apple-pay-button")}function T(e){return document.querySelector("#".concat(e))}function e1(e,n,t){var a=n.channels,o=a===void 0?[]:a,i=n.styles,r=i===void 0?{}:i,s={applePay:!1};return new Promise(function(c,l){if(e)if(B(o)){if(H(e))return s.applePay=!0,void c(s);(function(m,f){var p=f.container,y=f.integrity;return new Promise(function(h,C){var u=document.createElement("script");u.src=m,u.crossOrigin="anonymous",y&&(u.integrity=y),u.addEventListener("load",function(){h(!0)}),u.addEventListener("error",function(){u.remove(),C(!1)}),p?p.appendChild(u):document.head.appendChild(u)})})("https://applepay.cdn-apple.com/jsapi/v1.1.0/apple-pay-sdk.js",{container:e,integrity:"sha384-z/6BVHCcSypLSykOVpaT1PQWHOOgU45uOOlMkgi/bElX4yFqmChNMb7qiv80wFav"}).then(function(){if(t&&t!==1077497&&window&&!Array.isArray(window.webpackJsonp))throw new Error("Incorrect data type for 'webpackJsonp', expected array, got ".concat(_(window.webpackJsonp),". Switching to fallback apple pay button"));(function(m,f){var p,y,h,C,u,b=f.styles,k=f.theme,w=document.createElement("style"),P=(y=(p=b).height,h=p.width,C=p.borderRadius,u=p.padding,`
  apple-pay-button {
...
`));w.type="text/css",w.styleSheet?w.styleSheet.cssText=P:w.appendChild(document.createTextNode(P)),m.appendChild(w);var x=document.createElement("apple-pay-button");x.setAttribute("buttonstyle",k==="light"?"white":"black"),x.setAttribute("type",b.type),x.setAttribute("locale",b.locale),m.appendChild(x)})(e,{styles:G(r.applePay),theme:r.theme}),s.applePay=!0,c(s)}).catch(function(){(function(m,f){var p,y,h,C,u,b,k,w=f.styles,P=f.theme,x=document.createElement("style"),S=(y=(p=w).height,h=p.width,C=p.borderRadius,u=p.padding,b=p.type,k=p.locale,`
...
`));x.type="text/css",x.styleSheet?x.styleSheet.cssText=S:x.appendChild(document.createTextNode(S)),m.appendChild(x);var V=document.createElement("button");V.classList.add("apple-pay-button",P==="light"?"apple-pay-button-white":"apple-pay-button-black"),V.id="apple-pay-button";var E=document.createElement("span");E.classList.add("logo"),V.appendChild(E),m.appendChild(V)})(e,{styles:G(r.applePay),theme:r.theme}),s.applePay=!0,c(s)})}else l("No wallet payment method is available on this device");else l("Container to mount elements was not provided")})}function A1(e){for(;e.firstChild;)e.removeChild(e.firstChild)}var v1="payment-request-button",g1="paystackpop-button",b1="pay-with-vault-button";function k1(e){var n=document.createElement("button");return n.id=g1,n.className="open-paystack-pop-button",n.innerText=e,n}function w1(e){return e.querySelector("#".concat(g1))}function x1(){var e=document.createElement("div");return e.id=v1,e}function R(e){return e.querySelector("#".concat(v1))}function T1(e){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},t=document.createElement("div");t.className="vault-logo-container",t.innerHTML=`
...
`,e.appendChild(t);var a=document.createElement("p");a.id="instruction",a.className="vault-instruction",a.innerHTML="Access your saved cards and bank details for faster, more secure payments",e.appendChild(a);var o=(function(){var c=document.createElement("button");return c.className="pay-with-vault-button",c.id=b1,c.innerText="Pay with Vault",c})();e.appendChild(o);var i=document.createElement("div");if(i.className="vault-divider",i.innerHTML='<div id="vault-divider" class="vault-divider__container"><div class="vault-divider__line"></div></div><div class="vault-divider__text-container"><span class="vault-divider__text">or</span></div>',e.appendChild(i),n.canPayWithApplePay){var r=x1();e.appendChild(r)}if(n.hasOtherPaymentMethods){var s=k1("Use other payment methods");e.appendChild(s)}}function t1(e){return e.some(function(n){return n!=="apple_pay"})}function q1(e,n){var t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},a=document.querySelector("#pre-checkout-modal-".concat(e));if(a){if(w1(a)&&R(a))return a;a.remove()}var o=document.createElement("div");o.classList.add("pre-checkout-modal"),o.id="pre-checkout-modal-".concat(e),o.style.zIndex=n1()+1;var i=document.createElement("div");i.classList.add("pre-checkout-modal__content"),o.appendChild(i);var r=n||{},s=r.merchant_logo,c=r.merchant_name,l=r.email,m=r.amount,f=r.currency,p=r.label,y=r.channels,h=new Intl.NumberFormat("en",{style:"currency",currency:f,currencyDisplay:"code",maximumFractionDigits:2,minimumFractionDigits:0}).format(m/100),C=document.createElement("div");C.classList.add("payment-info"),C.innerHTML='<img class="merchant-logo" src="'.concat(s,'" alt="').concat(c,` Logo">
    <div class="customer-info">
      <div class="customer-email">`).concat(p||l,`</div>
...
`;var u=document.createElement("div");u.classList.add("modal-wrapper"),t.canPayWithVault?T1(u,{canPayWithApplePay:t.canPayWithApplePay,hasOtherPaymentMethods:t1(y)}):(function(P,x){var S=x.hasOtherPaymentMethods,V=document.createElement("div");V.innerHTML=`
...
`,P.appendChild(V);var E=document.createElement("p");E.id="apple-pay-description",E.innerHTML="Pay with Apple Pay to complete your purchase without filling a form",P.appendChild(E);var V1=x1();if(P.appendChild(V1),S){var L1=k1("More payment options");P.appendChild(L1)}})(u,{hasOtherPaymentMethods:t1(y)}),u.innerHTML=u.innerHTML+f1+`
...
`,i.appendChild(u);var b=document.createElement("style");if(b.textContent=`
  .pre-checkout-modal {
    display: none;
    position: fixed;
    z-index: 1;
...
`,n&&String(n.merchant_id)===String(550652)){var k=document.createElement("iframe");k.id="pre-checkout-modal-iframe-".concat(e),k.setAttribute("allow","payment"),k.style.cssText=["position: fixed","top: 0","left: 0","width: 100%","height: 100%","border: 0","margin: 0","background: transparent","z-index: ".concat(n1()+1)].join(";"),document.body.appendChild(k);var w=k.contentDocument||k.contentWindow.document;w.body.style.margin="0",w.head.appendChild(b),w.body.appendChild(o),o.remove=function(){return k.remove()}}else document.body.appendChild(b),document.body.appendChild(o);return o}var q=[{value:"key",required:!0,types:["string"]},{value:"amount",required:!0,or:["plan","planCode"],types:["string","number"]},{value:"currency",required:!1,types:["string"]},{value:"email",required:!0,or:["customerCode"],types:["string"]},{value:"label",required:!1,types:["string"]},{value:"firstName",required:!1,types:["string"]},{value:"lastName",required:!1,types:["string"]},{value:"reference",required:!1,types:["string"]},{value:"phone",required:!1,types:["string"]},{value:"customerCode",required:!1,override:"email",types:["string"]},{value:"channels",required:!1,types:["array"]},{value:"paymentRequest",required:!1,types:["string","number"]},{value:"paymentPage",required:!1,types:["string"]},{value:"hash",required:!1,types:["string"]},{value:"container",required:!1,types:["string"]},{value:"metadata",required:!1,types:["object"]},{value:"subaccountCode",required:!1,types:["string"]},{value:"bearer",required:!1,types:["string"]},{value:"transactionCharge",required:!1,types:["string","number"]},{value:"planCode",required:!1,override:"amount",types:["string"]},{value:"subscriptionCount",required:!1,types:["number"]},{value:"planInterval",required:!1,types:["string"]},{value:"subscriptionLimit",required:!1,types:["number"]},{value:"subscriptionStartDate",required:!1,types:["string"]},{value:"accessCode",required:!1,types:["string"]},{value:"onError",required:!1,types:["function"]},{value:"onLoad",required:!1,types:["function"]},{value:"onSuccess",required:!1,types:["function"]},{value:"onCancel",required:!1,types:["function"]},{value:"callback",required:!1,types:["function"]},{value:"onClose",required:!1,types:["function"]},{value:"onBankTransferConfirmationPending",required:!1,types:["function"]},{value:"firstname",required:!1,types:["string"]},{value:"lastname",required:!1,types:["string"]},{value:"customer_code",required:!1,types:["string"]},{value:"payment_request",required:!1,types:["string","number"]},{value:"subaccount",required:!1,types:["string"]},{value:"transaction_charge",required:!1,types:["number","string"]},{value:"plan",required:!1,types:["string"]},{value:"quantity",required:!1,types:["number"]},{value:"interval",required:!1,types:["string"]},{value:"invoice_limit",required:!1,types:["number","string"]},{value:"start_date",required:!1,types:["string"]},{value:"payment_page",required:!1,types:["number","string"]},{value:"order_id",required:!1,types:["number"]},{value:"ref",required:!1,types:["string"]},{value:"card",required:!1,types:["string"]},{value:"bank",required:!1,types:["string"]},{value:"split",required:!1,types:["object"]},{value:"split_code",required:!1,types:["string"]},{value:"transaction_type",required:!1,types:["string"]},{value:"subscription",required:!1,types:["number"]},{value:"language",required:!1,types:["string"]},{value:"connect_account",required:!1,types:["string"]},{value:"connect_split",required:!1,types:["array"]}];function H1(e){return(e==null?void 0:e.length)>500?e.split("?")[0]:e}function I1(e){var n,t,a,o,i=g({},e);return i.metadata=e.metadata||{},i.metadata.referrer=(n=window.location,t=n.href,a=t===void 0?"":t,o=n.ancestorOrigins,[a].concat(d1(o===void 0?[]:o)).map(H1).join(",")),i.metadata=JSON.stringify(i.metadata),i.mode="popup",e.split&&typeof e.split!="string"&&(i.split=JSON.stringify(i.split)),i.card!==void 0&&["false",!1].indexOf(i.card)>-1&&(i.channels=["bank"],delete i.card),i.bank!==void 0&&["false",!1].indexOf(i.bank)>-1&&(i.channels=["card"],delete i.bank),[{to:"firstname",from:"firstName"},{to:"lastname",from:"lastName"},{to:"customer_code",from:"customerCode"},{to:"payment_request",from:"paymentRequest"},{to:"subaccount",from:"subaccountCode"},{to:"transaction_charge",from:"transactionCharge"},{to:"plan",from:"planCode"},{to:"quantity",from:"subscriptionCount"},{to:"interval",from:"planInterval"},{to:"invoice_limit",from:"subscriptionLimit"},{to:"start_date",from:"subscriptionStartDate"},{to:"ref",from:"reference"}].forEach(function(r){i[r.from]&&(i[r.to]=i[r.from],delete i[r.from])}),Object.values(e).forEach(function(r,s){if(typeof r=="function"){var c=Object.keys(e)[s];delete i[c]}}),i}var z1=["iPad Simulator","iPhone Simulator","iPod Simulator","iPad","iPhone","iPod"],M1=window&&window.navigator&&(window.navigator.platform||window.navigator.userAgentData&&window.navigator.userAgentData.platform),P1=function(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},n=e.platform,t=e.userAgent,a=t===void 0?window&&window.navigator&&window.navigator.userAgent:t,o=n||M1;return z1.includes(o)||a.includes("Mac")&&"ontouchend"in document},O1=function(e,n,t){var a="".concat(M.paystackApiUrl,"transaction/update_log/").concat(e),o={Authorization:"Bearer ".concat(n)};return fetch(a,{method:"POST",body:JSON.stringify({payload:JSON.stringify(t)}),headers:o})},j1=function(e,n){var t="".concat(M.paystackApiUrl,"transaction/set_ip/").concat(e),a={Authorization:"Bearer ".concat(n)};return fetch(t,{method:"POST",headers:a})},N1={initializeLog:function(e){var n=e||{},t=n.attempts,a=n.authentication,o=n.errors,i=n.history;this.log={start_time:Math.round(Date.now()/1e3),time_spent:0,attempts:t||0,authentication:a,errors:o||0,success:!1,mobile:P1(),input:[],history:i||[]}},getTimeSpent:function(){var e=Math.round(Date.now()/1e3);return this.log.time_spent=e-this.log.start_time,this.log.time_spent},logAPIResponse:function(e,n){switch(e.status){case"success":return this.logApiSuccess(n);case"failed":return this.logApiError(e.message);default:return!1}},logValidationResponse:function(e){return this.log.history.push({type:"action",message:e,time:this.getTimeSpent()}),this.saveLog()},logAttempt:function(e){var n="Attempted to pay";return e&&(n+=" with ".concat(e)),this.log.attempts+=1,this.log.history.push({type:"action",message:n,time:this.getTimeSpent()}),this.saveLog()},logApiError:function(e){var n="Error";return e&&(n+=": ".concat(e)),this.log.errors+=1,this.log.history.push({type:"error",message:n,time:this.getTimeSpent()}),this.saveLog()},logApiSuccess:function(e){var n="Successfully paid";return e&&(n+=" with ".concat(e)),this.log.success=!0,this.log.history.push({type:"success",message:n,time:this.getTimeSpent()}),this.saveLog()},saveLog:function(){try{if(this.response)return O1(this.id,this.response.merchant_key,this.log)}catch(e){}},saveIpAddress:function(){try{if(this.response)return j1(this.id,this.response.merchant_key)}catch(e){}}},U1=["language","connect_account"],F1={requestInline:function(){var e=this,n=this.urlParameters,t=n.language,a=n.connect_account,o=Z(n,U1),i=g({"Content-Type":"application/json"},t&&{"Accept-Language":t});return(this.accessCode?fetch(new URL("transaction/verify_access_code/".concat(this.accessCode),M.paystackApiUrl).toString(),{headers:i}):fetch(new URL("/checkout/request_inline",M.paystackApiUrl).toString(),{method:"POST",body:JSON.stringify(o),headers:g(g({},i),a&&{"x-connect-account":a})})).then(function(r){return r.json()}).then(function(r){if(r.status===!1)throw new Error(r.message);return e.response=r.data,e.id=r.data.id,e.status=r.data.transaction_status,e.accessCode=r.data.access_code,e.log=null,Object.assign(e,N1),e.initializeLog(r.data.log),e.saveIpAddress(),r.data})}},O=(function(){return u1(function e(n){l1(this,e),(function(l){function m(h,C){this.message=h,this.issues=C||[]}if(!l||_(l)!=="object")throw new m("Transaction parameters should be a non-empty object");var f=l;if("accessCode"in f)return{accessCode:f.accessCode};Object.keys(f).forEach(function(h){q.find(function(C){return C.value===h})!==void 0||delete f[h]});var p=Object.keys(f),y=[];if(q.filter(function(h){return h.required}).forEach(function(h){var C=!f[h.value],u=h.or?h.or.some(function(b){return f[b]}):null;C&&!u&&y.push({message:"Required parameter missing: ".concat(h.value)})}),p.forEach(function(h){var C=f[h],u=q.find(function(k){return k.value===h}),b=_(C);b==="object"&&Array.isArray(C)&&(b="array"),u.types.indexOf(b)<=-1&&y.push({message:"Invalid parameter type: ".concat(h),validTypes:u.types})}),p.forEach(function(h){var C=q.find(function(u){return u.value===h});C.override&&delete f[C.override]}),y.length)throw new m("Invalid transaction parameters",y)})(n),this.parameters=n,this.urlParameters=I1(n),this.id=null,this.status=null,this.accessCode=n.accessCode||null,this.authorizationUrl=null,this.errors=[],this.response=null,this.isActive=!0;var t=n.onError,a=n.onLoad,o=n.onSuccess,i=n.onCancel,r=n.callback,s=n.onClose,c=n.onBankTransferConfirmationPending;this.callbacks={onError:t,onLoad:a,onSuccess:o,onCancel:i,onBankTransferConfirmationPending:c},this.deprecatedCallbacks={callback:r,onClose:s},Object.assign(this,F1)},[{key:"onSetupError",value:function(e){this.logError(e),this.callbacks.onError&&this.callbacks.onError(e)}},{key:"onLoad",value:function(e){var n=e.id,t=e.customer,a=e.accessCode;Object.assign(this,{id:n,customer:t,accessCode:a}),this.authorizationUrl="".concat(M.checkoutUrl).concat(a),this.callbacks.onLoad&&this.callbacks.onLoad({id:n,customer:t,accessCode:a})}},{key:"onSuccess",value:function(e){this.isActive=!1,this.response=e,this.status=e.status,this.callbacks.onSuccess&&this.callbacks.onSuccess(e),this.deprecatedCallbacks.callback&&this.deprecatedCallbacks.callback(e)}},{key:"setStatus",value:function(e){this.status=e}},{key:"onCancel",value:function(){this.callbacks.onCancel&&this.callbacks.onCancel(),this.deprecatedCallbacks.onClose&&this.deprecatedCallbacks.onClose()}},{key:"cancel",value:function(){this.isActive=!1,this.onCancel()}},{key:"onBankTransferConfirmationPending",value:function(){this.cancel(),this.callbacks.onBankTransferConfirmationPending&&this.callbacks.onBankTransferConfirmationPending()}},{key:"logError",value:function(e){this.errors.push(e)}}])})(),W=console?console.warn||console.log:function(){};function a1(e,n,t){W('"'.concat(e,'" has been deprecated, please use "').concat(n,'". ').concat(t))}var d,Z1=["preload","inlineTransaction","transactionData"],B1=["container","styles","onElementsMount"];function j(e,n){if(!e.length)return null;var t=e.filter(function(a){var o,i,r,s,c=!a.status||a.status==="abandoned",l=(o=a.parameters,i=n,r=Object.keys(o).sort().join("")===Object.keys(i).sort().join(""),s=Object.values(o).sort().join("")===Object.values(i).sort().join(""),r&&s);return c&&l});return t.length?t[t.length-1]:null}function i1(e){var n=e.checkoutIframe,t=e.urlParameters;n&&t&&n.contentWindow.postMessage({type:"inline:url",path:"newTransaction",params:t},"*")}var R1="trackCheckoutClosed",o1="trackPaymentError",D1="trackPaymentAttempt",W1="trackPaymentCompletion";function N(e){throw W(e),new Error(e)}var r1,c1,J1=(function(){function e(n){var t,a;l1(this,e),this.id=(function(){for(var o="",i="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",r=0;r<5;r+=1)o+=i.charAt(Math.floor(62*Math.random()));return o})(),this.transactions=[],this.isOpen=!1,this.isLoaded=!1,this.isDeprecatedApi=n&&n.isDeprecatedApi,n&&n.isEmbed?this.isEmbed=!0:n&&n.isPaymentRequest&&(n.container&&T(n.container)||N("A container is required to mount the payment request button"),this.paymentRequestContainer=T(n.container),this.paymentRequestTransaction=null),this.preCheckoutModal=null,this.backgroundIframe=(function(o){var i=z("inline-background-".concat(o));i.style.cssText=`
  ...
  visibility: hidden;
  display: none;
`,i.style.colorScheme="light",document.body.appendChild(i);var r=i.contentWindow.document;return r.open(),r.write(`
  <!DOCTYPE html>
  <html lang="en">
...
`),r.close(),i})(this.id),this.checkoutIframe=(t=this.id,(a=z("inline-checkout-".concat(t))).src="".concat(M.checkoutUrl,"popup"),a.style.cssText=`
  z-index: 999999999999999;
  background: transparent;
  border: 0px none transparent;
  overflow-x: hidden;
  ...
  display: none;
  height: 100%;
`,a.style.colorScheme="light",a.setAttribute("allowpaymentrequest","true"),a.setAttribute("allow","payment; clipboard-read; clipboard-write"),document.body.appendChild(a),a),this.registerListeners()}return u1(e,[{key:"registerListeners",value:function(){var n=this;window.addEventListener("message",function(t){var a="".concat(t.origin,"/")===M.checkoutUrl,o=n.checkoutIframe&&n.checkoutIframe.contentWindow===t.source,i=n.isEmbed;a||o?n.respondToEvent(t):i&&n.respondToEmbedEvents(t)})}},{key:"sendAnalyticsEventToCheckout",value:function(n,t){this.checkoutIframe.contentWindow.postMessage({type:"analytics",action:n,params:t},"*")}},{key:"checkout",value:function(n){this.activeTransaction()&&this.activeTransaction().cancel(),d=this;var t=j(this.transactions,n)||new O(n);return new Promise(function(a,o){t.requestInline().then(function(i){var r=(function(){var c=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},l=c.platform,m=c.userAgent,f=m===void 0?window&&window.navigator&&window.navigator.userAgent:m,p=l||M1,y=f&&!!f.match(/Version\/[\d.]+.*Safari/),h=p&&/(Mac)/i.test(p);return P1()||h&&y})()&&B(i.channels),s=(function(){var c,l,m=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};return!((c=m.link_config)===null||c===void 0||!c.enabled||(l=m.link_config)===null||l===void 0||!l.has_payment_instruments)})(i);s||r?(d.preloadTransaction({inlineTransaction:t,transactionData:i}),d.preCheckoutModal=q1(d.id,i,{canPayWithVault:s,canPayWithApplePay:r}),r?(d.paymentRequestContainer=R(d.preCheckoutModal),e1(d.paymentRequestContainer,{channels:i.channels,styles:{applePay:{width:"100%",type:"pay",height:"42px",padding:"15px",borderRadius:"5px"}}},i.merchant_id).then(function(){d.registerPaymentRequestEventListeners()}).catch(function(){s?R(d.preCheckoutModal).remove():(d.closePreCheckoutModal(),d.animateCheckoutIn())}).finally(function(){a(t)})):a(t)):(d.newTransaction({inlineTransaction:t,transactionData:i}),a(t))}).catch(function(i){t.onSetupError({status:!1,message:i.message}),o(i)})})}},{key:"openPreCheckoutModal",value:function(){var n;this.registerPreCheckoutModalEventListeners(),n=this.preCheckoutModal,new Promise(function(t,a){try{var o=n.querySelector(".pre-checkout-modal__content");n.classList.add("show"),setTimeout(function(){o.classList.add("show"),t(!0)},50)}catch(i){a(i)}})}},{key:"registerPreCheckoutModalEventListeners",value:function(){var n,t=this,a=!1,o=this.activeTransaction();document.addEventListener("touchstart",function(c){c.preventDefault(),a||(a=!0,n=setTimeout(function(){a=!1},125))},!0),document.addEventListener("touchend",function(c){c.target&&c.target.isSameNode(d.preCheckoutModal)&&a&&(clearTimeout(n),d.closePreCheckoutModal(),o&&o.cancel()),a=!1},!0);var i=w1(this.preCheckoutModal);i&&(i.onclick=function(){t.closePreCheckoutModal(),t.animateCheckoutIn()});var r=this.preCheckoutModal.querySelector("#".concat(b1));r&&(r.onclick=function(){t.closePreCheckoutModal(),t.animateCheckoutIn(),t.checkoutIframe.contentWindow.postMessage({type:"inline:pay-with-vault"},"*")});var s=(function(c){return c.querySelector("#apple-pay-close-button")})(this.preCheckoutModal);s.onclick=function(){t.sendAnalyticsEventToCheckout(R1),t.closePreCheckoutModalAndCancelTransaction()}}},{key:"closePreCheckoutModal",value:function(n){var t;this.preCheckoutModal&&(n==="failed"?(t=this.preCheckoutModal)&&(t.querySelector("#apple-pay-mark--light").innerHTML=`<svg width="50" height="30" viewBox="0 0 21 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="error-icon">
...
</svg>`,t.querySelector("#apple-pay-description").textContent="An error occurred while paying with Apple Pay. Please try again or use another payment method."):((function(a){a&&(a.querySelector(".pre-checkout-modal__content").classList.remove("show"),a.classList.remove("show"))})(this.preCheckoutModal),this.preCheckoutModal.remove(),this.preCheckoutModal=null))}},{key:"closePreCheckoutModalAndCancelTransaction",value:function(){this.preCheckoutModal&&(this.cancelTransaction(),this.checkoutIframe&&this.checkoutIframe.contentWindow&&this.checkoutIframe.contentWindow.postMessage("close","*"),this.closePreCheckoutModal())}},{key:"newTransaction",value:function(n){var t=n.preload,a=n.inlineTransaction,o=n.transactionData,i=Z(n,Z1),r=this.paymentRequestContainer&&H(this.paymentRequestContainer);if(this.activeTransaction()&&!r&&this.activeTransaction().cancel(),a&&o)return this.transactions.push(a),this.isDeprecatedApi||this.open({accessCode:o.access_code,language:a.urlParameters.language},t),a;var s=j(this.transactions,a?a.parameters:i);if(s)return s.isActive=!0,this.isDeprecatedApi||this.open({accessCode:s.accessCode,language:s.urlParameters.language},t),s;var c=a||new O(i),l=c.accessCode?{accessCode:c.accessCode,language:c.urlParameters.language}:c.urlParameters;return this.transactions.push(c),this.isDeprecatedApi||this.open(l,t),c}},{key:"preloadTransaction",value:function(n){var t=this;return this.newTransaction(g(g({},n),{},{preload:!0})),function(){return t.animateCheckoutIn()}}},{key:"paymentRequest",value:function(n){var t=n.container,a=n.styles,o=n.onElementsMount,i=Z(n,B1);return d=this,new Promise(function(r,s){var c=document.querySelector("#".concat(n.loadPaystackCheckoutButton));if(y1()){d.activeTransaction()&&d.activeTransaction().cancel(),t&&T(t)||N("A container is required to mount the payment request button"),d.paymentRequestContainer=T(t);var l=j(d.transactions,i),m=l||new O(i);m.requestInline().then(function(y){e1(d.paymentRequestContainer,{channels:y.channels,styles:a},y.merchant_id).then(function(h){o&&o(h)}).catch(function(){o&&o(null)}).finally(function(){if(l?m.isActive=!0:d.transactions.push(m),d.registerPaymentRequestEventListeners(),c){var h=d.preloadTransaction({inlineTransaction:m,transactionData:y});c.onclick=h}r(m)})}).catch(function(y){m.onSetupError({status:!1,message:y.message}),s(y)})}else{if(n&&n.loadPaystackCheckoutButton)if(c){var f=d.preloadTransaction(i);c.onclick=f}else W("This device does not support any payment request wallet options. Please consult our documentation at https://developers.paystack.co/docs/paystack-inline to see how to load alternative payment options using 'loadPaystackCheckoutButton'");o&&o(null);var p=d.activeTransaction();r(p)}})}},{key:"registerApplePayEventListener",value:function(){var n=this;H(this.paymentRequestContainer).onclick=function(){return n.startApplePay()}}},{key:"registerPaymentRequestEventListeners",value:function(){var n=this.activeTransaction();n&&B(n.response.channels)?this.registerApplePayEventListener():A1(this.paymentRequestContainer)}},{key:"startApplePay",value:function(){var n,t,a,o,i,r=this,s="apple pay",c=this.activeTransaction();if(c){var l={channel:"apple_pay",paymentMethod:s,currency:c.currency,amount:c.amount},m={channel:"apple_pay",currency:c.currency,amount:c.amount,timeSpent:c.getTimeSpent()};try{c.logAttempt(s),this.sendAnalyticsEventToCheckout(D1,l);var f=(n={currency:c.response.currency,amount:c.response.amount,merchantName:c.response.merchant_name,interval:c.response.plan_details&&c.response.plan_details.interval},t=n.currency,a=n.amount,o=n.merchantName,i=n.interval,g({countryCode:"NG",currencyCode:t,merchantCapabilities:["supports3DS","supportsCredit","supportsDebit"],supportedNetworks:["visa","masterCard"],requiredBillingContactFields:["postalAddress","name","phone","email"],total:{label:"".concat(o," - Paystack"),type:"final",amount:String(Y(a))}},typeof i=="string"&&i.trim()!==""&&{lineItems:[{label:E1(i),amount:String(Y(a))}]})),p=new window.ApplePaySession(M.applePayVersion,f);p.onvalidatemerchant=function(y){var h=(function(C){var u=C.transactionId,b=C.validationURL,k=C.merchantName,w=C.domainName,P=w===void 0?window&&window.location&&window.location.hostname:w,x="".concat(M.paymentBaseUrl).concat(M.applePayValidateSessionPath),S=$({transaction:u,sessionUrl:b,displayName:k,domainName:P});return fetch(x,g(g({},X),{},{body:S})).then(function(V){return V.json()})})({validationURL:y.validationURL,transactionId:c.id,merchantName:c.response.merchant_name});h.then(function(C){C.status!=="success"?c.onSetupError(C):p.completeMerchantValidation(C.data),c.logValidationResponse(C.message)}).catch(function(C){c.onSetupError(C)})},p.oncancel=function(){d.preCheckoutModal||c.onCancel()},p.onpaymentauthorized=function(y){var h=y.payment,C=(function(u){var b=u.transactionId,k=u.payment,w="".concat(M.paymentBaseUrl).concat(M.applePayChargePath),P=$({transaction:b,paymentObject:JSON.stringify(k)});return fetch(w,g(g({},X),{},{body:P})).then(function(x){return x.json()})})({transactionId:c.id,payment:h});C.then(function(u){c.logAPIResponse(u,s),u.status==="success"?(p.completePayment(p.STATUS_SUCCESS),c.onSuccess(u),r.sendAnalyticsEventToCheckout(W1,m)):(p.completePayment(p.STATUS_FAILURE),c.onSetupError(u),r.sendAnalyticsEventToCheckout(o1,{channel:"apple_pay",message:u&&u.message||"Transaction attempt failed"})),d.closePreCheckoutModal(u.status)}).catch(function(u){p.completePayment(p.STATUS_FAILURE),c.onSetupError(u),r.sendAnalyticsEventToCheckout(o1,{channel:"apple_pay",message:u&&u.message||"Error occurred"}),d.closePreCheckoutModal("failed")})},p.begin()}catch(y){c.onSetupError(y)}}else N("Could not initiate apple pay transaction")}},{key:"resumeTransaction",value:function(n){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},a=t.onSuccess,o=t.onCancel,i=t.onLoad,r=t.onError;return this.newTransaction({accessCode:n,onSuccess:a,onCancel:o,onLoad:i,onError:r})}},{key:"activeTransaction",value:function(){var n=this.transactions.filter(function(a){return a.isActive}),t=n.length?n[n.length-1]:null;return t}},{key:"cancelTransaction",value:function(n){var t=this.transactions.find(function(a){return a.id===n})||this.activeTransaction();t&&(t.cancel(),this.close())}},{key:"respondToEvent",value:function(n){if(n){var t,a,o=this.activeTransaction();try{var i=n.data||n.message,r=i.event,s=i.data;if(r)switch(r){case"loaded:checkout":if(this.isLoaded=!0,o){var c=this.checkoutIframe,l=o.urlParameters,m=o.response;i1({checkoutIframe:c,urlParameters:m?{accessCode:m.access_code,language:l==null?void 0:l.language}:l})}break;case"loaded:transaction":t=this.backgroundIframe,(a=t.contentWindow.document)&&(a.getElementById("app-loader").style.display="none"),this.preCheckoutModal&&this.openPreCheckoutModal(),o.onLoad(s);break;case"error":s.type==="setup"?o.onSetupError(s):o.logError(s);break;case"cancel":case"close":this.close();var f=s&&s.status;f&&o.setStatus(f),!(this.paymentRequestContainer&&H(this.paymentRequestContainer)&&!this.preCheckoutModal)&&(o.isActive=!1),o.onCancel();break;case"transfer:pending":this.close();var p=s&&s.status;p&&o.setStatus(p),o.onBankTransferConfirmationPending();break;case"success":this.close(),o.onSuccess(s)}}catch(y){}}}},{key:"respondToEmbedEvents",value:function(n){var t,a,o=this.activeTransaction(),i=n.data||n.message;if(i&&(typeof i=="string"||i instanceof String)){var r={action:a=(t=i)&&typeof t=="string"?t.split(" ")[0]:null,data:a?t.split(" ").slice(2).join(" "):null};r&&r.action==="PaystackClose"&&r.data&&o.onSuccess(i),r.action==="PaystackTLSClose"&&o.cancel()}}},{key:"animateCheckoutIn",value:function(){var n,t=this;if(!this.isOpen){var a=this.checkoutIframe,o=this.backgroundIframe;(n={checkoutIframe:a,backgroundIframe:o},new Promise(function(i,r){n||r("No dom element provided");var s=n.checkoutIframe,c=n.backgroundIframe;s&&c||r("No dom element provided"),s.style.display="",s.style.visibility="visible",c.style.display="",c.style.visibility="visible",i()})).then(function(){t.checkoutIframe.contentWindow.postMessage("render","*")}),this.isOpen=!0}}},{key:"open",value:function(n,t){n&&(i1({checkoutIframe:this.checkoutIframe,urlParameters:n}),t||this.animateCheckoutIn())}},{key:"close",value:function(){var n=this;if(this.isOpen){var t,a=this.checkoutIframe,o=this.backgroundIframe;(t={checkoutIframe:a,backgroundIframe:o},new Promise(function(i,r){t||r("No dom element provided");var s=t.checkoutIframe,c=t.backgroundIframe;s&&c||r("No dom element provided"),c.style.opacity=0,s.style.display="none",s.style.visibility="hidden",setTimeout(function(){c.style.display="none",c.style.visibility="hidden",c.style.opacity=1,i()},300)})).then(function(){n.checkoutIframe.contentWindow.postMessage("close","*")}),this.isOpen=!1}}},{key:"isLoaded",value:function(){return this.isLoaded}}],[{key:"setup",value:function(n){var t=n&&n.container;d||(d=new e({isDeprecatedApi:!0,isEmbed:t})),a1("PaystackPop.setup()","new PaystackPop()","Please consult our documentation at https://developers.paystack.co/docs/paystack-inline");var a=d.newTransaction(n,"deprecated"),o=a.urlParameters;if(t){var i="".concat(M.siteUrl,"/assets/payment/production/inline.html?").concat(m1(o)),r=(function(s,c){var l=z("embed-checkout-".concat(s));return l.style.cssText=`
  background: transparent;
  ...
  visibility: hidden;
  display: none;
`,l.src=c,l.id=s,l.name=s,l.setAttribute("allowpaymentrequest","true"),l.setAttribute("allow","payment; clipboard-read; clipboard-write"),l})(d.id,i);(function(s,c){var l=document.getElementById(s);l.innerHTML="",l.removeAttribute("style"),l.className="paystack-embed-container",l.style.position="relative",l.style.width="100%",l.appendChild(c)})(n.container,r),r.onload=function(){var s;r.contentWindow.postMessage("PaystackOpen ".concat(d.id),"*"),s=r,new Promise(function(c,l){s||l("No dom element provided"),s.style.display="",s.style.visibility="visible",c()})}}else a.openIframe=function(){a1("openIframe","open","Please consult our documentation at https://developers.paystack.co/docs/paystack-inline"),d.open(o)};return a}}])})();if(r1=Q().length>0,c1=A()&&A().parentElement.tagName==="FORM",r1&&c1){var U,L=(function(){var e={},n=A();return Q().forEach(function(t){var a=n.getAttribute(t),o=t.split("data-")[1].replace(/-([a-z])/g,function(i){return i[1].toUpperCase()});e[o]=a}),(function(t){if(t.buttonId&&!document.getElementById(t.buttonId))throw new Error("Please make sure the buttonId is an element available in the DOM");var a=g({},t);a.buttonText=t.buttonText||"Pay",a.buttonVariant="normal",a.buttonWordmarkVariant="normal";var o=["normal","light"];return t.buttonVariant&&o.indexOf(t.buttonVariant)>-1&&(a.buttonVariant=t.buttonVariant),t.buttonWordmarkVariant&&o.indexOf(t.buttonWordmarkVariant)>-1&&(a.buttonWordmarkVariant=t.buttonWordmarkVariant),a})(e)})(),s1=A().parentElement;d||(d=new J1),(function(e){var n;if(e.id)(n=document.getElementById(e.id)).setAttribute("data-inline-id",e.id);else{var t=document.createElement("div");t.id="inline-button-".concat(e.inlineId),t.innerHTML=(function(a){var o,i,r={normal:`
  <svg id="inline-button-wordmark" width="137" height="13" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <style>
      ...
      #inline-button-`).concat(a.inlineId,`__trigger {
        `).concat((o=a.variant||"normal",i={normal:`
  ...
  `).concat(i[o])),`
    ...
    <div id="inline-button-`).concat(a.inlineId,`__wordmark">
      `).concat(r[a.wordmarkVariant||"normal"],`
    </div>
  `)})(e),e.parent.parentNode.insertBefore(t,e.parent.nextSibling),n=_1(t.getElementsByTagName("button"),1)[0]}return n})({inlineId:d.id,amount:L.amount/100,currency:L.currency,id:L.buttonId,text:L.buttonText,variant:L.buttonVariant,wordmarkVariant:L.buttonWordmarkVariant,parent:A()}).addEventListener("click",function(e){e.preventDefault(),U?d.resumeTransaction(U.accessCode):U=d.newTransaction(g(g({},L),{},{onSuccess:function(n){var t,a,o,i,r,s;t={type:"hidden",name:"reference",value:n.reference,parent:s1},a=t.type,o=t.value,i=t.name,r=t.parent,(s=document.createElement("input")).type=a,s.value=o,s.name=i,r.appendChild(s),s1.submit()}}))})}export{J1 as default};
